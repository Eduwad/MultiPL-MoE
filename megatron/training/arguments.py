...
def _add_network_size_args(parser):
    ...
    group.add_argument('--norm-epsilon', type=float, default=1e-6,
...
def _add_moe_args(parser):
    ...
    group.add_argument('--enable-shared-expert', action='store_true',
                       help='Scaling coefficient for the aux loss: a starting value of 1e-2 is recommended.')
    group.add_argument('--zero-expert-down-proj', action='store_true',
                       help='Scaling coefficient for the aux loss: a starting value of 1e-2 is recommended.')
    group.add_argument('--moelpr-train-embeddings', action='store_true',
                       help='Scaling coefficient for the aux loss: a starting value of 1e-2 is recommended.')
    group.add_argument('--context-window',  type=int, default=64,
                       help='At the sentence level, convert the token to the window size of the segment')
    group.add_argument('--capacity',  type=float, default=1,
                       help='At the sentence level, the maximum number of times each segment can be selected by different experts')
    group.add_argument('--expert-choise-bucket',  type=int, default=4,
                       help='At the sentence level, how many experts can choose a segment at most')
    group.add_argument('--weight-token', type=float, default=0.7,
                       help='Weight of token level output')
    group.add_argument('--weight-sentence', type=float, default=0.3,
                       help='Weight of sentence level output.')
    group.add_argument('--token-level-expert-num', type=int, default=4,
                       help='The expert number in token level')
    group.add_argument('--sentence-level-expert-num', type=int, default=8,
                       help='The expert number in sentence level')
    return parser
