...
def load_checkpoint(model, optimizer, opt_param_scheduler, load_arg='load', strict=True,
    ...
    # Model.
    strict = False if args.retro_add_retriever else strict # true

    if len(model) == 1:
        # lm_head_weight = state_dict['model']['embedding.word_embeddings.weight']
        # state_dict['model']['output_layer.weight'] = lm_head_weight
