...
def build_tokenizer(args, **kwargs):
    ...
    if args.tokenizer_type == 'BertWordPieceLowerCase':
        ...
        assert args.tokenizer_model is not None
        tokenizer = _AutoTokenizer(args.tokenizer_model)
...
class _HuggingFaceTokenizer(MegatronTokenizer):
    def __init__(self, pretrained_model_name_or_path, **kwargs):
        ...
        self.model_config = AutoConfig.from_pretrained(pretrained_model_name_or_path=pretrained_model_name_or_path, **kwargs)
