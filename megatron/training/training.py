...
def train_step(forward_step_func, data_iterator,
    ...
    # print(model[0].module.module.output_layer.weight.main_grad)
    # print(model[0].module.module.embedding.word_embeddings.weight.main_grad)
    # print(model[0].module.module.decoder.layers[23].mlp.experts.local_experts[0].linear_fc2.weight)
    args = get_args()
    timers = get_timers()
    
    # if data_iterator is not None:
    #     data_iterator, debug_iterator = tee(data_iterator, 2)
    #     inputs = next(debug_iterator)
    ...
    losses_reduced = forward_backward_func(
        ...
        forward_only=False)
    # print(model[0].module.module.decoder.layers[23].mlp.router.weight.main_grad)
