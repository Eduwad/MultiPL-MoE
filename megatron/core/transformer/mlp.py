...
class MLP(MegatronModule):
    ...
    def __init__(
        ...
        if is_expert is True and self.config.enable_shared_expert:
    ...
    def forward(self, hidden_states, lang_mask=None):
        ...
        if self.config.bias_activation_fusion:
            ...
            elif self.activation_func == F.silu and self.config.gated_linear_unit: # here
