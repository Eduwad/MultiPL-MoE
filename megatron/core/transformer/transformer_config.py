...
class TransformerConfig(ModelParallelConfig):
    ...
    """at sentence level,the context window."""
    capacity: float = 1
    """at sentence level,the maximum number of times each segment can be selected by different experts"""
    expert_choise_bucket: int = 4
    """at sentence level,how many experts can choose a segment at most"""
    weight_token: float = 0.7
    """In the final output, the weight of the token level"""
    weight_sentence: float = 0.3
    """In the final output, the weight of the senetnce level"""
    token_level_expert_num: int = 4
    """The expert number in token level"""
    sentence_level_expert_num: int = 8
    """The expert number in sentence level"""
